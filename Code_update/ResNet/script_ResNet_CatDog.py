...
renew_model = load_model('/home/pkustudent/notebooks/full_model2/ResNet_CatDog_full.h5')  #加载已经保存好的模型
...
filepath_1 = f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/CatDog/ResNet-CatDog-percentage{percentage}-update{update}-start{start}-new'
if os.path.exists(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/CatDog/ResNet-CatDog-percentage{percentage}-update{update}-start{start}-new'):
    shutil.rmtree(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/CatDog/ResNet-CatDog-percentage{percentage}-update{update}-start{start}-new')
else:
    os.mkdir(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/CatDog/ResNet-CatDog-percentage{percentage}-update{update}-start{start}-new')
