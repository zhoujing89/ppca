...
renew_model = load_model('/home/pkustudent/notebooks/full_model/ResNet_cifar100_full.h5')  #加载已经保存好的模型
...
filepath_1 = f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/Cifar100/ResNet-cifar100-percentage{args.percentage}-update{args.update}-start{args.start}-' + date
