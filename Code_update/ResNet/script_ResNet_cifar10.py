...
renew_model = load_model('/home/pkustudent/notebooks/full_model/ResNet_cifar10_full.h5')  #加载已经保存好的模型
...
filepath_1 = f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/ResNet/Cifar10/ResNet-cifar10-percentage{args.percentage}-update{args.update}-start{args.start}-' + date
