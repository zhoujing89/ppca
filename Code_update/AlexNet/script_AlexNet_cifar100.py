...
renew_model = load_model('/home/pkustudent/notebooks/full_model/AlexNet_cifar100_full.h5')  #加载已经保存好的模型
...
filepath_1 = f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/AlexNet/Cifar100/AlexNet-cifar100-percentage{percentage}-update{update}-start{start}-' + date
if os.path.exists(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/AlexNet/Cifar100/AlexNet-cifar100-percentage{percentage}-update{update}-start{start}-'+ date):
    shutil.rmtree(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/AlexNet/Cifar100/AlexNet-cifar100-percentage{percentage}-update{update}-start{start}-'+ date)
else:
    os.mkdir(f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/AlexNet/Cifar100/AlexNet-cifar100-percentage{percentage}-update{update}-start{start}-'+ date)
