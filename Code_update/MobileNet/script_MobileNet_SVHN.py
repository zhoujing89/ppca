...
renew_model = load_model('/home/pkustudent/notebooks/full_model/MobileNet_SVHN_full.h5')  #加载已经保存好的模型
...
filepath_1 = f'/home/pkustudent/notebooks/PPCA_update/PPCA_update/MobileNet/SVHN/MobileNet-SVHN-percentage{args.percentage}-update{args.update}-start{args.start}-' + date
