...
renew_model = load_model('ResNet32_Cifar10_V2.h5')  #加载已经保存好的模型
...
renew_model.save(f"ResNet32-cifar10-percentage{args.percentage}-update{args.update}-start{args.start}-blocklayer{args.blocklayer}-{output_acc}.h5")