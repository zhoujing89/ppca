...
renew_model = load_model('VGG_Cifar10_V2.h5')  #加载已经保存好的模型
...
renew_model.save(f"vgg16-cifar10-percentage{args.percentage}-update{args.update}-start{args.start}-{output_acc}.h5")